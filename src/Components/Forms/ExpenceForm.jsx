...
function ExpenceForm() {
    ...
    const {addExpence}=useGlobalContext()
            ...
            /></div>
             <div className="selects input-control">
                <select required value={catagory} name='catagory' id='catagory' onChange={handleInput('catagory')} className='w-80 ring-1 ml-2 ring-gray-300 rounded-md px-4 py-2 mt-2 outline-none focus:ring-2 focus:ring-teal-300'>
                  ...
                  <option value="PayAsLoan">Pay As Loan</option>
                  <option value="Petrol">Petrol</option>
                  <option value="Rent">Rent</option>
                  <option value="ElectricityBill">Electricity Bill</option>
                  <option value="GasBill">Gas Bill</option>
                  <option value="giveMoney">Give Money</option>
                  <option value="PayEMI">EMIs</option>
